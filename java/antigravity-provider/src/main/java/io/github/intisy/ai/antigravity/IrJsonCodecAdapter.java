 ...
 * structurally identical {@link io.github.intisy.ai.ir.spi.JsonCodec} (SP-2). Every call site in
 ...
 * duplicating a codec. Mirrors stub-auth's {@code StubProvider.RoutingJsonCodecAdapter} (SP-2
 * canary, commit 99bcc62) and claude-code-auth's identical {@code IrJsonCodecAdapter} (ff112d9).
 */
